...
declare module "electron-builder/out/publish/bintray" {
  ...
  export class BintrayClient {
    ...
    constructor(owner: string, packageName: string, repo?: string, apiKey?: string | null)
...
declare module "electron-builder/out/util/util" {
  ...
  export function installDependencies(appDir: string, electronVersion: string, arch: string, forceBuildFromSource: boolean, command?: string): BluebirdPromise<any>
